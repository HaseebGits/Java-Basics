//In this code i use Hierarchical Inheritence and Polymorphism concept to make this project.
...
class SavingAccount extends Account{
    ...
    public void withdraw(double amount){
        if(amount > 0 && (balance-amount)> minimumBalance){
            ...
            System.out.println("Cannot withdraw minimum balance will be maintained");
        }
    }
...
class CurrentAccount extends Account {
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            Sa.deposit(200);
            Sa.withdraw(500);
            Sa.withdraw(900);//Amount exceed no withdraw transaction occur

            System.out.println("Current Account Transaction are ");
            Ca.display();
            Ca.deposit(100);
            Ca.withdraw(1500);
            Ca.display();
